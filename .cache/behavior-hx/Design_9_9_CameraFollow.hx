...
class Design_9_9_CameraFollow extends ActorScript
{
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				engine.moveCamera((_currentCameraX + ((getMouseX() - actor.getScreenX()) * 0.4)), (_currentCameraY + ((getMouseY() - actor.getScreenY()) * 0.4)));
			}
		});
